...
var Nav = React26.forwardRef((_ref, ref) => {
  let {
    // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
    as: Component2 = "div",
    onSelect,
...
var ListGroupItem = React27.forwardRef(({
  bsPrefix,
  active,
  disabled,
  eventKey,
...
var ListGroup = React28.forwardRef((props, ref) => {
  const {
    className,
...
function getReactVersion() {
  const parts = React29.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
var RTGTransition = React30.forwardRef((_ref, ref) => {
  let {
    component: Component2
  } = _ref, props = _objectWithoutPropertiesLoose3(_ref, _excluded3);
  const transitionProps = useRTGTransitionProps(props);
  return (0, import_jsx_runtime30.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime31.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime31.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime31.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
var Modal = (0, import_react18.forwardRef)((_ref, ref) => {
  let {
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime32.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime32.jsx)("div", Object.assign({}, dialogProps, {
    children: React32.cloneElement(children, {
      role: "document"
    })
  }));
  ...
  return (0, import_jsx_runtime32.jsx)(import_jsx_runtime33.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime34.jsxs)(import_jsx_runtime33.Fragment, {
...
var ModalBody = React33.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalContext = React34.createContext({
...
var AbstractModalHeader = React37.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  return (0, import_jsx_runtime39.jsxs)("div", {
    ref,
    ...props,
    children: [children, closeButton && (0, import_jsx_runtime38.jsx)(CloseButton_default, {
...
var Modal2 = React40.forwardRef(({
  ...
  const renderBackdrop = (0, import_react20.useCallback)((backdropProps) => (0, import_jsx_runtime42.jsx)("div", {
    ...backdropProps,
...
var NavItem = React41.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Nav2 = React42.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
...
var NavbarBrand = React43.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React44.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
...
var NavbarToggle = React45.forwardRef(({
  bsPrefix,
  className,
  children,
...
var OffcanvasBody = React46.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React47.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime49.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React47.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React48.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React49.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React50.forwardRef(({
  ...
  const renderBackdrop = (0, import_react26.useCallback)((backdropProps) => (0, import_jsx_runtime52.jsx)("div", {
    ...backdropProps,
...
var NavbarText = React52.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React53.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime67.jsxs)(import_jsx_runtime66.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react33.cloneElement)(children, triggerProps), (0, import_jsx_runtime65.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PlaceholderButton = React64.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime71.jsx)(Button_default, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var ToastFade = React78.forwardRef((props, ref) => (0, import_jsx_runtime87.jsx)(Fade_default, {
  ...props,
  ref,
