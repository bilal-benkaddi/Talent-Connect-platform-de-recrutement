...
import {
  NavItem_default,
  Nav_default
} from "./chunk-2NWH5FML.js";
import "./chunk-6WYJCDID.js";
import {
  NavLink_default
} from "./chunk-PXSKOAHF.js";
import {
  TabContext_default
} from "./chunk-ZAO4DFBV.js";
import {
  Badge_default
} from "./chunk-N7ENERFR.js";
import {
  addClass,
  hasClass,
  removeClass
...
function getReactVersion() {
  const parts = React25.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
var RTGTransition = React26.forwardRef((_ref, ref) => {
  let {
    component: Component2
  } = _ref, props = _objectWithoutPropertiesLoose2(_ref, _excluded2);
  const transitionProps = useRTGTransitionProps(props);
  return (0, import_jsx_runtime26.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime27.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime27.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime27.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
var Modal = (0, import_react17.forwardRef)((_ref, ref) => {
  let {
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime28.jsx)("div", Object.assign({}, props)),
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime28.jsx)("div", Object.assign({}, dialogProps, {
    children: React28.cloneElement(children, {
      role: "document"
    })
  }));
  ...
  return (0, import_jsx_runtime28.jsx)(import_jsx_runtime29.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime30.jsxs)(import_jsx_runtime29.Fragment, {
...
var ModalBody = React29.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalContext = React30.createContext({
...
var AbstractModalHeader = React33.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
  ...
  return (0, import_jsx_runtime35.jsxs)("div", {
    ref,
    ...props,
    children: [children, closeButton && (0, import_jsx_runtime34.jsx)(CloseButton_default, {
...
var Modal2 = React36.forwardRef(({
  ...
  const renderBackdrop = (0, import_react19.useCallback)((backdropProps) => (0, import_jsx_runtime38.jsx)("div", {
    ...backdropProps,
...
var NavbarCollapse = React38.forwardRef(({
  ...
  return (0, import_jsx_runtime40.jsx)(Collapse_default, {
...
var NavbarToggle = React39.forwardRef(({
  ...
  return (0, import_jsx_runtime41.jsx)(Component2, {
    ...
    onClick: handleClick,
    "aria-label": label,
    className: (0, import_classnames29.default)(className, bsPrefix, !expanded && "collapsed"),
    children: children || (0, import_jsx_runtime41.jsx)("span", {
...
var OffcanvasBody = React40.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React41.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime43.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    in: inProp,
    mountOnEnter,
    ...
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React41.cloneElement(children, {
      ...innerProps,
      className: (0, import_classnames31.default)(className, children.props.className, (status === ENTERING || status === EXITING) && `${bsPrefix}-toggling`, transitionStyles[status])
    })
  });
});
...
var OffcanvasHeader = React42.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React43.forwardRef(({
  className,
  bsPrefix,
...
function DialogTransition2(props) {
  return (0, import_jsx_runtime46.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
...
var Offcanvas = React44.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const renderBackdrop = (0, import_react24.useCallback)((backdropProps) => (0, import_jsx_runtime46.jsx)("div", {
    ...backdropProps,
  ...
  return (0, import_jsx_runtime48.jsxs)(import_jsx_runtime47.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime46.jsx)(ModalContext_default.Provider, {
      value: modalContext,
...
var NavbarOffcanvas = React45.forwardRef((props, ref) => {
  const context3 = (0, import_react25.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime49.jsx)(Offcanvas_default, {
    ref,
...
var NavbarText = React46.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React47.forwardRef((props, ref) => {
  const {
  ...
  return (0, import_jsx_runtime51.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime61.jsxs)(import_jsx_runtime60.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react31.cloneElement)(children, triggerProps), (0, import_jsx_runtime59.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime80.jsxs)(Tabs_default, {
    ...
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime79.jsx)(Nav_default, {
      id,
      ...controlledProps,
      role: "tablist",
      as: "ul",
