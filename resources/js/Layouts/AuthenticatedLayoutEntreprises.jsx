...
export default function AuthenticatedLayout({ entreprise, header, children }) {
    return (
        <div className="min-vh-100 bg-light">
            <nav className="navbar navbar-expand-lg navbar-light bg-white border-bottom border-gray-100">
                <div className="container">
                    <Link className="navbar-brand" href="/entreprises">
                        Application Logo
                    </Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <Link className="nav-link" href={route('entreprises.dashboard')} active={route().current('entreprises.dashboard')}>
                                    Dashboard
                                </Link>
                            </li>
                        </ul>
