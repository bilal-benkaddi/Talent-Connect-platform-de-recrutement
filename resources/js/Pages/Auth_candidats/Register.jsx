...
export default function Register() {
    ...
    const submit = (e) => {
        ...
        post(route("candidats.register"));
    };

    return (
        <GuestLayout>
            <Head title="Register" />
            <h1>candidats register</h1>
            <form onSubmit={submit}>
                ...
                <div>
                    ...
                    <InputError message={errors.prename} className="mt-2" />
                </div>
                ...
                <div className="mt-4">
                    ...
                    <InputError
                        message={errors.date_de_naissance}
                        className="mt-2"
                    />
                </div>
                ...
                <div className="mt-4">
                    ...
                    <InputError
                        message={errors.Adresse_postale}
                        className="mt-2"
                    />
                </div>
