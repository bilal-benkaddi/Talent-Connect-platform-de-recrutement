                    ...
                    {entreprise ? (
                        ...
                        <div className="col-12 text-center">
                            ...
                            <p className="mb-5 lead">
                                Talent Connect is your premier platform for finding the perfect job opportunities. Whether you're a seasoned professional or just starting out, we have the right tools and connections to help you succeed in your career journey.
                            </p>
                            <p className="mb-4 text-muted">
                                Join thousands of candidates who have found their dream jobs through our platform. Our user-friendly interface and powerful search capabilities make job hunting effortless and efficient.
                            </p>
                            <p className="mb-4">
                            ...
                            <ul className="list-unstyled mb-4">
                                ...
                                <li className="mb-2">
                                    <i className="bi bi-check-circle-fill text-success me-2"></i>
                                    Access to exclusive job listings from top companies.
                                </li>
                                <li className="mb-2">
                                    <i className="bi bi-check-circle-fill text-success me-2"></i>
                                    Career resources and tips to help you stand out in the job market.
                                </li>
                            </ul>
                        ...
                        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                            {offers.map((offer) => {
                                ...
                                const differenceInDays = Math.floor(
                                    (offerDeadline - currentDate) / (1000 * 60 * 60 * 24)
                                );
                                        ...
                                        <Card className="h-100">
                                            <Card.Body>
                                                ...
                                                <Card.Subtitle className="mb-2 text-muted">
                                                    Entreprise: {offer.entreprise ? offer.entreprise.nom_Entreprise : "N/A"}
                                                </Card.Subtitle>
                                                <Card.Text>
                                                    <strong>Domaine:</strong> {offer.domaine}<br />
                                                    <strong>Niveau d'Étude:</strong> {offer.niveau_etude}<br />
                                                    <strong>Expérience:</strong> {offer.experience}<br />
                                                    <strong>Nombre de Postes:</strong> {offer.nombre_poste}<br />
                                                    <strong>Secteur d'Activité:</strong> {offer.secteur_activite}<br />
                                                    <strong>Type d'Emploi:</strong> {offer.type_emploi}<br />
                                                    <strong>Lieu:</strong> {offer.lieu}<br />
                                                    <strong>Description:</strong> {offer.description.substring(0, 25)}...<br />
                                                    <strong>Date de Publication:</strong> {offer.date_Publication}<br />
                                                    <strong>Date Limite de Candidature:</strong> {offer.date_limite_candidature}<br />
                                                    <strong>Salaire:</strong> {offer.salaire}<br />
                                                    <strong>Type de Contrat:</strong> {offer.type_contrat}<br />
                                                    {differenceInDays < 0 ? (
                                                        <h4 className="text-danger">Offer closed</h4>
                                                    ) : (
                                                        <div className="d-grid gap-2">
                                                            <span className="text-success">
                                                                {differenceInDays} {differenceInDays === 1 ? "day" : "days"} left to apply
                                                            </span>
                                                            <button onClick={() => closeOffer(offer.id)} className="btn btn-warning">
                                                                Close Offer
                                                            </button>
                                                        </div>
                                                    )}
                                                ...
                                                <div className="d-grid gap-2">
                                                    <Link href={route("offres.show", offer.id)} className="btn btn-primary">
                                                        Show
                                                    </Link>
                                                    <Link href={route("offres.edit", offer.id)} className="btn btn-primary">
                                                        Edit
                                                    </Link>
